package org.stm.pegelhub.connector.ma;

import lombok.extern.slf4j.Slf4j;
import org.stm.pegelhub.connector.ma.config.MaConfigLoader;
import org.stm.pegelhub.connector.ma.config.MaConnectorOptions;
import org.stm.pegelhub.connector.ma.core.MaReadJob;
import org.stm.pegelhub.connector.ma.core.InputRegistry;
import org.stm.pegelhub.connector.ma.core.MaConnectorScheduler;
import org.stm.pegelhub.connector.ma.jni.RevPiReader;
import org.stm.pegelhub.connector.ma.jni.RevPiReaderImpl;
...
public class MaConnectorApplication {
     ...
     *
     * @param args optional path to config.properties at index 0
     */
