...
public class TstpWriter implements Runnable, AutoCloseable {
    ...
    public TstpWriter(PegelHubClient coreClient, TstpCommunicator tstpCommunicator, Duration durationToLookBack, UUID timeSeriesId, TstpCatalogService tstpCatalogService) {
