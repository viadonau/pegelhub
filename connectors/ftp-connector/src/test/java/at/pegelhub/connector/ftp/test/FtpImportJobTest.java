...
import at.pegelhub.connector.ftp.FtpConnectorSettings;
...
public class FtpImportJobTest {
    ...
    private FtpConnectorSettings conOpts;
    ...
    public void nothingIsSentWhenFTPThrowsIOException() throws IOException {
        ...
        var newTask = new FtpImportJob(mockClient, conOpts, comm, mockParser);
    ...
    public void onlyConfiguredParameterIsSent() throws Exception {
        ...
        new FtpImportJob(mockClient, options, comm, parser).run();
    ...
    public class TestWithRunningServer {
        ...
        public void setup(TestInfo t) throws Exception {
            ...
            task = new FtpImportJob(client, newConOpts, comm, parser);
        }
    ...
    private static FtpConnectorSettings options(ParserType parserType, int stationId, String parameter, int ftpPort) throws Exception {
