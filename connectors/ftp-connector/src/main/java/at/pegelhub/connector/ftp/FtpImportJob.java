...
public class FtpImportJob implements Runnable {
    ...
    private final FtpConnectorSettings conOpts;
    private final PegelHubClient communicator;
    private final Parser parser;

    public FtpImportJob(FTPClient ftp, FtpConnectorSettings conOpts, PegelHubClient communicator, Parser parser) {
        this.ftp = ftp;
        this.conOpts = conOpts;
        this.communicator = communicator;
        this.parser = parser;
        this.durationToLookBack = conOpts.pollInterval();
    }
    ...
    public void run(){
        ...
        try {
            ...
            FTPFile[] files;
            try {
                LOG.debug("Listing files under {}", conOpts.path());
