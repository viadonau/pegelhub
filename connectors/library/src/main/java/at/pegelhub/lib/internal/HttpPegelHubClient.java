...
public class HttpPegelHubClient implements PegelHubClient {
    ...
    private boolean isOAuthConfigured() {
        return hasText(credentials.tokenUrl()) && hasText(credentials.clientId()) && hasText(credentials.clientSecret());
    }
    ...
    private synchronized String fetchAccessToken() {
        ...
        try {
            var http = new HttpPost(URI.create(credentials.tokenUrl()));
            http.setHeader("Content-Type", "application/x-www-form-urlencoded");
            List<NameValuePair> form = List.of(
                    new BasicNameValuePair("grant_type", "client_credentials"),
                    new BasicNameValuePair("client_id", credentials.clientId()),
                    new BasicNameValuePair("client_secret", credentials.clientSecret()));
    ...
    public HttpPegelHubClient(CloseableHttpClient client, URL baseUrl, ClientCredentials credentials) {
        this.client = client;
