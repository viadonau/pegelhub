...
public record WriteMeasurementRequest(
        @Schema(description = "Time series that receives this measurement.", format = "uuid", example = "018f5f4c-8d4a-7b1a-9f7b-0f6f6f6f6f6f")
        @NotNull UUID timeSeriesId,
        @Schema(description = "Time at which the value was observed.", type = "string", format = "date-time", example = "2026-06-17T12:00:00Z")
