...
@Schema(
        description = "openapi.measurement.measurement-list-response.lean-envelope-of-raw-measurements-for-one")
public record MeasurementListResponse(
        @Schema(
                description = "openapi.measurement.measurement-list-response.time-series-whose-"
        ...
        @Schema(
                description = "openapi.measurement.measurement-list-response.requested-maximum-number-of-raw-points",
                example = "1000")
        int limit,
        @Schema(
                description = "openapi.measurement.measurement-list-response.whether-more-points-exist-"
                        + "in-the-requested",
                example = "false")
        boolean truncated,
