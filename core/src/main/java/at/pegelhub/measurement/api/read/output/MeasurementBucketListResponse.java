...
@Schema(
        description = "openapi.measurement.measurement-bucket-list-response.chart-ready-average-buckets-for-one-time")
public record MeasurementBucketListResponse(
        @Schema(
                description = "openapi.measurement.measurement-bucket-list-response.time-series-whose-"
        ...
        @Schema(
                description = "openapi.measurement.measurement-bucket-list-response.bucket-resolution-"
