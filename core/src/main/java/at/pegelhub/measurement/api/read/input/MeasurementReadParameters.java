...
public record MeasurementReadParameters(
        ...
        Instant to,
        @Schema(
                description = "openapi.measurement.measurement-read-parameters.sort-order-by-observed-time",
                allowableValues = {"asc", "desc"},
                defaultValue = "asc")
        String order,
        @Schema(
                description = "openapi.measurement.measurement-read-parameters.maximum-raw-points-to-return",
                minimum = "1",
                maximum = "10000",
                defaultValue = "1000")
