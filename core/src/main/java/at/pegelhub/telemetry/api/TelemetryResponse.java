...
@Schema(description = "Technical connector telemetry entry.")
public record TelemetryResponse(
        @JsonProperty("measurement")
        @Schema(description = "Telemetry identifier stored for this point.", example = "a93fdc3d-b71f-44ce-a826-fe1dc1f1f357")
        ...
        @Schema(description = "Legacy station-observed water temperature. New integrations should read this from TimeSeries Measurements.", example = "12.4", nullable = true, deprecated = true)
        Double legacyTemperatureWater,
        @JsonProperty("temperatureAir")
        @Schema(description = "Legacy station-observed air temperature. New integrations should read this from TimeSeries Measurements.", example = "18.7", nullable = true, deprecated = true)
