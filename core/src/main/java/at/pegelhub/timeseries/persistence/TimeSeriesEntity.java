...
class TimeSeriesEntity {
    ...
    @Column
    private UUID sourceInternalProducerId;
    ...
    TimeSeriesEntity(
            ...
            UUID sourceInternalProducerId) {
        this.id = id;
        this.measuringPointId = measuringPointId;
        this.observedProperty = observedProperty;
        this.status = status;
        this.sourceConnectorId = sourceConnectorId;
        this.sourceInternalProducerId = sourceInternalProducerId;
    ...
    UUID sourceInternalProducerId() {
        return sourceInternalProducerId;
    }
