...
For an operational acceptance run, record UTC times, check transitions, and the
actual traps received by both receivers. Local lab results do not authorize a
production change.
